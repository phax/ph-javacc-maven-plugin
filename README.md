...
v5.0.3 - 2026-09-09
* Updated to ParserGeneratorCC 3.0.0
* Fixed the `jjdoc` report not documenting grammars created during the build (like the ones generated by JJTree or JTB), because the forked `generate-sources` lifecycle was lost when the plugin switched to Maven plugin annotations
