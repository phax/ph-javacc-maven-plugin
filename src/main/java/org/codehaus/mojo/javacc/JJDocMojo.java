...
public class JJDocMojo extends AbstractMavenReport
{
   ...
   */
  @Parameter (defaultValue = "${basedir}/src/main/javacc", readonly = true)
  private File defaultGrammarDirectoryJavaCC;

  /**
   * The default source directory for grammar files generated by JJTree.
   */
  @Parameter (defaultValue = "${project.build.directory}/generated-sources/jjtree", readonly = true)
  private File defaultGrammarDirectoryJJTree;

  /**
   * The default source directory for grammar files generated by JTB.
   */
  @Parameter (defaultValue = "${project.build.directory}/generated-sources/jtb", readonly = true)
   ...
   */
  @Parameter (property = "oneTable", defaultValue = "true")
  ...
  {
    return getBundle (aLocale).getString ("report.jjdoc.name");
  }
  ...
  {
    return getBundle (aLocale).getString ("report.jjdoc.short.description");
  }
   ...
   */
  @Override
  public void executeReport (final Locale aLocale) throws MavenReportException
  {
    final Sink sink = getSink ();

    createReportHeader (getBundle (aLocale), sink);
  ...
  {
    return ResourceBundle.getBundle ("jjdoc-report", aLocale, getClass ().getClassLoader ());
  }
