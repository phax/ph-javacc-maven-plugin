 ...
 * JavaCC in order to finally generate a parser with parse tree actions.
 *
 * @since 2.4
...
public class JJTreeJavaCCMojo extends AbstractJavaCCMojo
{
   ...
   * nodes used in the grammar. Default value is <code>true</code>.
   */
  @Parameter (property = "buildNodeFiles")
  private Boolean buildNodeFiles;

  /**
   * A flag whether to generate a multi mode parse tree or a single mode parse tree. Default value
   * is <code>false</code>.
   */
   ...
   * class for the generated tree node classes. By default, the tree node classes will directly
   * extend the class <code>SimpleNode</code>.
   *
   * @since 2.5
   */
  ...
  /**
   * The name of a custom factory class used to create <code>Node</code> objects. This class must
   * have a method with the signature <code>public static Node jjtCreate(int id)</code>. By default,
   * the class <code>SimpleNode</code> will be used as the factory class.
   */
  @Parameter (property = "nodeFactory")
  private String nodeFactory;

  /**
   * The package to generate the AST node classes into. This value may use a leading asterisk to
   * reference the package of the corresponding parser. For example, if the parser package is
   * <code>org.apache</code> and this parameter is set to <code>*.node</code>, the tree node classes
   * will be located in the package <code>org.apache.node</code>. By default, the package of the
   * corresponding parser is used.
   */
  @Parameter (property = "nodePackage")
  private String nodePackage;

  /**
   * The prefix used to construct node class names from node identifiers in multi mode. Default
   ...
   * scope. Default value is <code>false</code>.
   */
   ...
   * the parser object. Default value is <code>false</code> .
   */
   ...
   * <code>jjtSetFirstToken()</code>, <code>getLastToken()</code> and <code>jjtSetLastToken()</code>
   * into the class <code>SimpleNode</code>. Default value is <code>false</code>.
   *
   * @since 2.5
   */
   ...
   * a visitor implementation with an entry for every node type used in the grammar. Default value
   * is <code>false</code>.
   */
  ...
  /**
   * The name of a class to use for the data argument of the <code>jjtAccept()</code> and
   * <code>visit()</code> methods. Default value is <code>java.lang.Object</code>.
   *
   * @since 2.5
   */
  ...
  /**
   * The name of a class to use as the return type of the <code>jjtAccept()</code> and
   * <code>visit()</code> methods. Default value is <code>java.lang.Object</code>.
   *
   * @since 2.5
   */
   ...
   * <code>jjtAccept()</code> and <code>visit()</code> methods. By default, the <code>throws</code>
  ...
  /**
   * The directory where the decorated JavaCC grammar files (<code>*.jjt</code>) are located. It
   * will be recursively scanned for input files to pass to JJTree. The parameters
   * <code>includes</code> and <code>excludes</code> can be used to select a subset of files.
   */
  @Parameter (property = "sourceDirectory", defaultValue = "${basedir}/src/main/jjtree")
  private File sourceDirectory;

  /**
   * The directory where the AST node files generated by JJTree will be stored. The directory will
   ...
   * <code>**&#47;*.jjt</code> and <code>**&#47;*.JJT</code> are used to select grammar files.
   */
  @Parameter
