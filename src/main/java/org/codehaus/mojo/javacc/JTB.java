...
class JTB extends AbstractToolFacade
{
   ...
   *
   * @param value
   *        The absolute path to the output directory for the generated grammar file. If this
   *        directory does not exist yet, it is created. Note that this path should already include
   *        the desired package hierarchy because JTB will not append the required sub directories
   *        automatically.
   */
   ...
   *
   * @return The absolute path to the output directory for the syntax tree files, only
   *         <code>null</code> if neither {@link #outputDirectory} nor {@link #nodeDirectory} have
   *         been set.
   */
   ...
   *
   * @param value
   *        The absolute path to the output directory for the generated visitor files, may be
   *        <code>null</code> to use a sub directory in the output directory of the grammar file. If
   *        this directory does not exist yet, it is created. Note that this path should already
   *        include the desired package hierarchy because JTB will not append the required sub
   *        directories automatically.
   ...
   *
   * @param name
   *        The package name from which to retrieve the last sub package, may be <code>null</code>.
   * @return The name of the last sub package or <code>null</code> if the input was
   *         <code>null</code>
   */
   ...
   *
   * @param sourceDir
   *        The absolute path to the source directory, must not be <code>null</code>.
   * @param targetDir
   *        The absolute path to the target directory, must not be <code>null</code>.
   * @throws IOException
   *         If the move failed.
   */
  private void moveDirectory (final File sourceDir, final File targetDir) throws IOException
  {
    ...
    /*
     * NOTE: The source directory might be the current working directory if JTB was told to output
     * into the default package. The current working directory might be quite anything and will
     * likely contain sub directories not created by JTB. Therefore, we do a defensive move and only
     * delete the expected Java source files.
     */
