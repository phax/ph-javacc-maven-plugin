 ...
 * higher. This goal will not work with earlier versions of the JRE.
 *
 * @since 2.4
...
public class JTBJavaCCMojo extends AbstractJavaCCMojo
{
   ...
   * <code>&lt;packageName&gt;.syntaxtree</code> and <code>visitorPackageName</code> =
   * <code>&lt;packageName&gt;.visitor</code>. Note that this option takes precedence over
   * <code>nodePackageName</code> and <code>visitorPackageName</code> if specified.
   */
  @Parameter (property = "package")
  private String packageName;

  /**
   * This option specifies the package for the generated AST nodes. This value may use a leading
   * asterisk to reference the package of the corresponding parser. For example, if the parser
   * package is <code>org.apache</code> and this parameter is set to <code>*.demo</code>, the tree
   * node classes will be located in the package <code>org.apache.demo</code>. Default value is
  ...
  /**
   * This option specifies the package for the generated visitors. This value may use a leading
   * asterisk to reference the package of the corresponding parser. For example, if the parser
   * package is <code>org.apache</code> and this parameter is set to <code>*.demo</code>, the
   * visitor classes will be located in the package <code>org.apache.demo</code>. Default value is
   * <code>*.visitor</code>.
   */
  ...
  /**
   * If <code>true</code>, JTB will suppress its semantic error checking. Default value is
   * <code>false</code>.
   */
   ...
   * so that they are formatted correctly in API docs. Default value is <code>false</code>.
   */
   ...
   * structure of the tree instead of generic names like <code>f0</code>, <code>f1</code> etc.
  ...
  /**
   * The qualified name of a user-defined class from which all AST nodes will inherit. By default,
   * AST nodes will inherit from the generated class <code>Node</code>.
   */
  @Parameter (property = "nodeParentClass")
  private String nodeParentClass;

  /**
   * If <code>true</code>, all nodes will contain fields for its parent node. Default value is
   * <code>false</code>.
   */
  ...
  /**
   * If <code>true</code>, JTB will include JavaCC "special tokens" in the AST. Default value is
   * <code>false</code>.
   */
  ...
  /**
   * If <code>true</code>, JTB will generate a syntax tree dumping visitor. Default value is
   * <code>false</code>.
   */
  ...
  /**
   * The directory where the JavaCC grammar files (<code>*.jtb</code>) are located. It will be
  ...
  /**
   * The directory where the visitor and AST node files generated by JTB will be stored. The
   * directory will be registered as a compile source root of the project such that the generated
   ...
   * processing. By default, the patterns <code>**&#47;*.jj</code> , <code>**&#47;*.JJ</code>,
   * <code>**&#47;*.jtb</code> and <code>**&#47;*.JTB</code> are used to select grammar files.
   */
  @Parameter
  private String [] includes;

  /**
   * A set of Ant-like exclusion patterns used to prevent certain files from being processing. By
  ...
  /**
   * Creates a new facade to invoke JTB. Most options for the invocation are derived from the
   * current values of the corresponding mojo parameters. The caller is responsible to set the input
   * file, output directories and packages on the returned facade.
   *
